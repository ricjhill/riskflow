...
class TestJobStatus:
    ...
    def test_get_pending_job(self) -> None:
        ...
        job = Job.create()
        asyncio.get_event_loop().run_until_complete(store.save(job))
...
class TestListJobs:
    ...
    def test_list_jobs_ordered_newest_first(self) -> None:
        ...
        asyncio.get_event_loop().run_until_complete(store.save(old_job))
        asyncio.get_event_loop().run_until_complete(store.save(new_job))
